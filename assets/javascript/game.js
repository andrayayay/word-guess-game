...
// Choosing a randon word

var states = ["south Carolina", "wisconsin", "washington", "texas", "minnesota","hawaii"];
...
function initialize() {
	...
	lettersGuessed = [];
	correctGuesses = 0;
	wordPlace = Math.floor(Math.random() * 6);
...
function checkForWin() {
	if (dashesArray.indexOf("_") === -1) {
		document.innerHTML("You got it! The correct answer is " + currentWord);
		numWins++;
